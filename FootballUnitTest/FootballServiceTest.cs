...
namespace FootballEngineUnitTest
{
    ...
    public class FootballServiceTest
    {
        ...
        public async Task GetGroupsTest()
        {
            ...
            var footballDataService = new FootballDataService(httpAPIClient.Object, _mockFootballDataState.Object, null);
        ...
        private HttpAPIClient GetTestHttpAPIClient(FootballEngineInput footballEngineinput)
        {
            var httpClient = new HttpClient();

            return new HttpAPIClient(httpClient, footballEngineinput);
        }
    }
}
