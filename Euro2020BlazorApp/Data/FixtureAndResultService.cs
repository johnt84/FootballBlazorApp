...
namespace Euro2020BlazorApp.Data
{
    public class FixtureAndResultService
    {
        ...
        public FixtureAndResultService(FootballDataModel footballDataModel, ITimeZoneOffsetService timeZoneOffsetService)
        {
        ...
        public async Task<List<FixturesAndResultsByDay>> GetFixturesAndResults()
        {
            ...
            var fixturesAndResults = _footballDataModel
                                        .matches
                                        .ToList()
